...
func CreateInvoice() {
	...
	// 	pdf.CellFormat(30, 10, strconv.Itoa(v.Rate), "0", 0, "L", false, 0, "")
	// 	pdf.CellFormat(20, 10, strconv.Itoa(v.Quantity), "0", 0, "L", false, 0, "")
	// 	pdf.CellFormat(0, 10, strconv.Itoa(v.Amount), "0", 0, "R", false, 0, "")
	// 	pdf.Ln(-1)
	// }
